...
<form action="{{ route('update-mahasiswa', $mahasiswa->nim) }}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" name="nim" class="form-control" id="nim" placeholder="Nomor Induk Mahasiswa" value="{{ $mahasiswa->nim }}" readonly>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Masukan nama dengan benar" value="{{ $mahasiswa->nama_lengkap }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <select name="prodi" id="prodi" class="form-control">
                ...
                <option value="{{ $item->kode_prodi }}" {{ ($mahasiswa->prodi==$item->kode_prodi) ? 'selected' : '' }}>{{ $item->nama_prodi }}</option>
                @endforeach
            </select>
